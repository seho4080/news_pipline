...
with DAG(
    dag_id='hdfs_spark_daily_report_dag',
    ...
    submit_spark_job = SparkSubmitOperator(
        ...
        application='/opt/airflow/dags/scripts/spark_daily_report_hdfs.py',
        ...
        conf={
            ...
            "spark.hadoop.fs.defaultFS": "hdfs://host.docker.internal:9000"
        },
        verbose=True,
    )
    # # 하루치 사용한 JSON 파일 이동
